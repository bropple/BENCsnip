# dmgbuild settings for the BENCsnip disk image.
#
...
#
#   dmgbuild -s tools/dmg-settings.py -D app=BENCsnip.app BENCsnip out.dmg

import os.path

application = defines.get("app", "BENCsnip.app")      # noqa: F821 - dmgbuild
...
_icns = os.path.join(application, "Contents", "Resources", "BENCsnip.icns")
...
# and the other has to move with it - see tools/make-dmg-background.sh, which
# reads these same three numbers.
